...
module.exports = {
    ...
    methods: {
        async scrapePlayerStats() {
            ...
            fs.writeFileSync('./user/data/officialPlayerStats.json', aoeJSON);
        },
        ...
        shouldUpdate() {
            ...
            let msSinceUpdate = (Math.abs(new Date().getTime() - this.lastUpdatedDate('./user/data/aoe3GameStats.json')));
