<template>
	<div class="p-inputgroup obs-transform-number">
		<label-floater v-model="strModel" :label="label" :input-id="inputId" v-slot="labelProps">
			...
			>
				<number-field v-model="numModel" v-bind="templateProps" ref="numInput" />
			</template-toggle>
		</label-floater>
		<!-- <p-button
			class="ml-1"
...
import { LabelFloater, TemplateToggle, CContextMenu, useDataBinding, NumberField } from "castmate-ui-core"
