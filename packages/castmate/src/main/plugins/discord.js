        ...
        this.webhooks = new Resource(DiscordWebHook, {
            ...
            config: {
                ...
                properties: {
                    ...
                    url: { type: String, name: "Discord Webhook URL", secret: true }
                }
            }
        })
    ...
    actions: {
        discordMessage: {
            ...
            data: {
                type: Object,
                properties: {
                    channel: { type: DiscordWebHook, name: "Channel", required: true },
                    message: { type: String, name: "Message", template: true, required: true },
                }
            },
